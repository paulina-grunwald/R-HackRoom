...
In example presented belw we will first filter the air_time and distance columns for NA values ad then group the data by carrier and using summarise function calculate mean distance, sum of air time and number of observations for each carrier.
