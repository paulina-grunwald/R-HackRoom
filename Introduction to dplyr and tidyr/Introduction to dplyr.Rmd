...
The mutate() function can be used to add new variables to a dataframe or derive new information from the existing dataframe. It requires the original data.frame as the first argument and then arguments to create new variables as the remaining arguments. 
